                        ...
                        >
                            <div className="bg-secondary-blue rounded-3xl p-8 md:p-10 shadow-2xl relative overflow-hidden">
                                ...
                                <p className="text-gray-300 mb-8 relative z-10 leading-relaxed text-lg">
                                    {service.title} ve diğer tedavi yöntemlerimiz hakkında uzman fizyoterapistimizden detaylı bilgi alabilirsiniz.
                                </p>

                                <div className="space-y-4 relative z-10">
                                    <a
                                        href={`https://wa.me/${contactInfo.whatsapp}?text=Merhaba, ${service.title} hakkında bilgi almak istiyorum.`}
                                        target="_blank"
